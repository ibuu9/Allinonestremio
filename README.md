...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i7ilaey.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i7ilaey.containers.anotherwebservice.com/
...
```
git clone git@github.com:ibuu9/Allinonestremio.git
cd container-i7ilaey
```
...
```
docker attach container-i7ilaey
```
